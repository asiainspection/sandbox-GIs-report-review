...
GIs = [
    ("ribkoff", ROOT / "data/pipeline/checkpoints/ribkoff_checkpoints.json"),
    ("dfi", ROOT / "data/pipeline/checkpoints/dfi_checkpoints.json"),
    ("hallmark", ROOT / "data/pipeline/checkpoints/hallmark_checkpoints.json"),
]
